...
SCRIPT;
	...
	protected function renderContent()
	{
		...
		foreach($this->models as $index=>$model)
		{
			...
			/* mostofa add part */
			//$this->controller->renderPartial($this->inputView, array('model'=>$model, 'index'=>$index,'form'=>$this->form));
			/* end mostofa add part */
	...
	{
		$removeLink=CHtml::link($this->removeLabel, $this->removeUrl, $this->removeHtmlOptions).'<input type="hidden" class="'.$this->indexCssClass.'" value="'.$index.'" />';
